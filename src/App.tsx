...
function App() {
  return (
    <div className="min-h-screen flex">
      ...
      <main className="md:ml-64 flex-1 p-4 md:p-8 bg-gray-50">
        <section id="accueil" className="min-h-screen flex items-center">
          <div>
            <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Bienvenue sur mon Portfolio</h1>
            <p className="text-base md:text-lg text-gray-600 max-w-2xl mb-6 md:mb-8">
              ...
              Mon expertise inclut React, TypeScript, Node.js et bien plus encore.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
              <a href="#projets" className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 md:px-6 md:py-3 rounded-md transition text-center">
                Voir mes projets
              </a>
              <a href="#contact" className="border border-blue-600 text-blue-600 hover:bg-blue-50 px-4 py-2 md:px-6 md:py-3 rounded-md transition text-center">
                Me contacter
              </a>
            </div>
          </div>
        ...
        <section id="projets" className="min-h-screen py-12 md:py-16">
        ...
        <section id="competences" className="min-h-screen py-12 md:py-16">
