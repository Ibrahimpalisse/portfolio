...
const Home = ({ scrollToProjects }) => {
  ...
  return (
    <div className="min-h-screen w-full text-white relative overflow-hidden md:pl-64 pb-24 md:pb-0">
      ...
      <div 
        ...
        className="absolute bottom-4 md:bottom-8 left-1/2 transform -translate-x-1/2 cursor-pointer animate-bounce z-20"
      >
        <svg className="w-8 h-8 md:w-10 md:h-10 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
